...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/mkv_rockers)
            ],
            [
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🎥 Main Channel 🎥', url='https://t.me/mkv_Rockers')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/mkv_rockers')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
