...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("🎬M ovie 🎬", url="https://t.me/mkv_rockers"),
                InlineKeyboardButton("🎟️Series 🎟️", url="https://t.me/+Qqjm_YjQ09ViZWQ1")
            ])

    btn.insert(0, [
        InlineKeyboardButton("🤖 Bro, Check Bot PM First 🤖", url=f"https://t.me/{temp.U_NAME}")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('💌 Support 💌', url='https://t.me/+Qqjm_YjQ09ViZWQ1'),
                InlineKeyboardButton('🎥 Channel 🎥', url='https://t.me/mkv_rockers')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/mkvrequestroom')
            ]
            ]
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("Dei Puluthi,I Like Your Smartness, But Don't Be Oversmart 😒", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates 📢', url='https://t.me/mkv_rockers'),
            InlineKeyboardButton('🍿 Movie Club 🍿', url='https://t.me/mkvrequestroom')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status ⭕', url='https://t.me/mkv_rockers'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("🎬 Movie 🎬", url="https://t.me/mkv_rockers"),
        InlineKeyboardButton("🎥Series 🎥", url="https://t.me/+Qqjm_YjQ09ViZWQ1")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/mkv_rockers")
    ])
